  ...
  return (
    <div className="w-full bg-light_green-50 pt-[30px] sm:pt-5">
      <div className="flex flex-col items-center">
        ...
        <div className="mt-[120px] flex h-[900px] w-[94%] items-center justify-center bg-[url(/images/img_group_118.svg)] bg-cover bg-no-repeat py-[120px] md:h-auto md:w-full md:p-5 md:py-5">
        ...
        <div className="mt-[120px] flex w-[94%] rounded-[50px] bg-white-A700 md:w-full md:p-5">
          <div className="flex h-[730px] w-full items-center justify-center rounded-[50px] bg-[url(/images/img_group_119.png)] bg-cover bg-no-repeat py-[119px] md:h-auto md:py-5">
        ...
        <Footer className="mt-[225px] self-stretch bg-teal-900 pt-[30px] sm:pt-5" />
      </div>
    </div>
  );
}
